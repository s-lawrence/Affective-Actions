...
class Yolo():
    ...
    def get_object_data(self, layerOutputs, image_width, image_height):
        ...
        # loop over each of the detections
            for detection in output:
                ...
                if confidence > self.confidence_bound and classID != 60:
    ...
    def parse_object_data(self, boxes, confidences, classIDs, centers):
        # apply non-maxima suppression to suppress weak, overlapping bounding boxes
        idxs = cv2.dnn.NMSBoxes(boxes, confidences, self.confidence_bound, self.threshold)
        boxes_list, confidences_list, classID_list, centers_list = [], [], [], []
        ...
        if len(idxs) > 0:
            ...
            for i in idxs.flatten():
                ...
                centers_list.append(centers[i])
        return boxes_list, confidences_list, classID_list, centers_list
